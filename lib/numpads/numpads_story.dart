...
import 'package:ui_kit/numpads/numpad_text.dart';
                ...
                Container(
                    ...
                    child: PasscodeNumPadText(
                      ...
                      hasSecondaryActionButton:
                          props['hasSecondaryActionButton'],
                      secondaryActionWidget: Icon(Icons.fingerprint,
                          color: AppColor.blue, size: 25),
                      onSecondaryActionButtonPressed: () {
                        _showDialog(
                            context, '', 'Secondary action button pressed');
                      },
                    ))
              ]);
            }));
